...
employees_data = [
  { first_name: 'Simonette', last_name: 'Pagin', email: 'qjcun4@ecoharb.com', phone_number: '3917017188', password: 'zO8|,', employment_date: '2004-08-29', department_id: 1, role: 'Procurement Manager' },
  { first_name: 'Erv', last_name: 'Cartin', email: 'owjyi3@ecoharb.com', phone_number: '3082975792',  password: 'zI3*.}zk', employment_date: '2016-10-25', department_id: 2, role: 'Procurement Manager' },
  { first_name: 'Germain', last_name: 'Gusticke', email: 'yuzfm1@ecoharb.com', phone_number: '6839896145',  password: 'sQ7"oV', employment_date: '2005-01-08', department_id: 3, role: 'Normal Employee' },
  { first_name: 'Yevette', last_name: 'Fennelow', email: 'tmstr2@ecoharb.com', phone_number: '5301509488',  password: 'xI8>', employment_date: '2006-05-20', department_id: 4, role: 'Normal Employee' },
  { first_name: 'Robbin', last_name: 'Denson', email: 'nnsbw1@ecoharb.com', phone_number: '2585132940',  password: 'bB2!mP', employment_date: '2018-09-24', department_id: 5, role: 'Normal Employee' },
  { first_name: 'Boyce', last_name: 'Kuhne', email: 'vyynd0@ecoharb.com', phone_number: '5812559884',  password: 'vE5"wy', employment_date: '1998-10-20', department_id: 6, role: 'Normal Employee' },
  { first_name: 'Dick', last_name: 'Passfield', email: 'lahuy5@ecoharb.com', phone_number: '4373522110',  password: 'tA4(', employment_date: '2013-01-09', department_id: 7, role: 'Normal Employee' },
 ]

Employee.create(employees_data)
puts "Created #{Employee.count} employees"

AssetsDirectory.delete_all
...
approvals_data = [
  { request_id: 1, approval_status: 'rejected', approval_date: '4/9/2011', comments: 'vel ipsum praesent blandit lacinia erat vestibulum' },
  { request_id: 2, approval_status: 'rejected', approval_date: '2/7/2013', comments: 'mi pede malesuada in imperdiet et' },
  { request_id: 3, approval_status: 'approved', approval_date: '5/24/1981', comments: 'consequat in consequat ut nulla sed accumsan felis ut' },
  { request_id: 4, approval_status: 'approved', approval_date: '8/13/2018', comments: 'id justo sit amet sapien dignissim' },
  { request_id: 5, approval_status: 'approved', approval_date: '8/1/2012', comments: 'sagittis nam congue risus semper porta volutpat quam pede lobortis' },
  { request_id: 6, approval_status: 'rejected', approval_date: '6/7/2023', comments: 'nulla dapibus dolor vel est donec odio justo sollicitudin' },
  { request_id: 7, approval_status: 'pending', approval_date: '8/26/2012', comments: 'condimentum neque sapien placerat ante nulla justo aliquam quis' },
  { request_id: 8, approval_status: 'rejected', approval_date: '3/4/2003', comments: 'maecenas pulvinar lobortis est phasellus sit amet erat nulla' },
  { request_id: 9, approval_status: 'pending', approval_date: '1/24/2015', comments: 'suscipit ligula in lacus curabitur at ipsum ac tellus' },
  {  request_id: 10, approval_status: 'rejected', approval_date: '8/23/1983', comments: 'vel enim sit amet nunc viverra' },
  {  request_id: 11, approval_status: 'rejected', approval_date: '12/13/2005', comments: 'adipiscing elit proin risus praesent lectus vestibulum quam' },
  {  request_id: 12, approval_status: 'rejected', approval_date: '5/4/2010', comments: 'est phasellus sit amet erat nulla tempus' },
  {  request_id: 13, approval_status: 'rejected', approval_date: '9/30/2020', comments: 'non mi integer ac neque duis bibendum' },
  {  request_id: 14, approval_status: 'pending', approval_date: '12/20/2004', comments: 'dictumst etiam faucibus cursus urna' },
  {  request_id: 15, approval_status: 'pending', approval_date: '6/19/1984', comments: 'blandit ultrices enim lorem ipsum dolor sit' },
  {  request_id: 16, approval_status: 'pending', approval_date: '10/16/2012', comments: 'fusce lacus purus aliquet at feugiat non' },
  {  request_id: 17, approval_status: 'rejected', approval_date: '9/9/1986', comments: 'hendrerit at vulputate vitae nisl aenean lectus pellentesque eget nunc' },
  {  request_id: 18, approval_status: 'approved', approval_date: '8/7/2006', comments: 'erat volutpat in congue etiam justo etiam pretium' },
  {  request_id: 19, approval_status: 'approved', approval_date: '5/14/2021', comments: 'aliquam convallis nunc proin at turpis a pede' },
  {  request_id: 20, approval_status: 'rejected', approval_date: '4/16/2021', comments: 'nec molestie sed justo pellentesque viverra pede' },
  {  request_id: 21, approval_status: 'pending', approval_date: '12/6/2000', comments: 'dictumst aliquam augue quam sollicitudin' },
  {  request_id: 22, approval_status: 'pending', approval_date: '4/1/2013', comments: 'arcu adipiscing molestie hendrerit at vulputate vitae' },
  {  request_id: 23, approval_status: 'rejected', approval_date: '11/16/1980', comments: 'non interdum in ante vestibulum ante ipsum primis in faucibus' },
  {  request_id: 24, approval_status: 'rejected', approval_date: '8/3/1998', comments: 'quam nec dui luctus rutrum nulla tellus in sagittis dui' },
  {  request_id: 25, approval_status: 'pending', approval_date: '6/10/1983', comments: 'primis in faucibus orci luctus et' },
  {  request_id: 26, approval_status: 'pending', approval_date: '4/25/2010', comments: 'etiam justo etiam pretium iaculis justo in hac habitasse platea' },
  {  request_id: 27, approval_status: 'approved', approval_date: '5/2/2023', comments: 'quis lectus suspendisse potenti in eleifend quam a' },
  {  request_id: 28, approval_status: 'pending', approval_date: '3/1/2019', comments: 'sed tristique in tempus sit amet sem fusce consequat' },
  {  request_id: 29, approval_status: 'rejected', approval_date: '7/14/2009', comments: 'mi in porttitor pede justo eu' },
  {  request_id: 30, approval_status: 'rejected', approval_date: '7/10/2015', comments: 'luctus et ultrices posuere cubilia curae' },
  {  request_id: 31, approval_status: 'rejected', approval_date: '12/13/2002', comments: 'tellus nisi eu orci mauris lacinia sapien' },
  {  request_id: 32, approval_status: 'approved', approval_date: '9/1/1988', comments: 'maecenas leo odio condimentum id luctus nec molestie' },
  {  request_id: 33, approval_status: 'pending', approval_date: '8/9/2000', comments: 'integer a nibh in quis justo maecenas rhoncus aliquam' },
  {  request_id: 34, approval_status: 'pending', approval_date: '5/3/1994', comments: 'id lobortis convallis tortor risus dapibus augue vel accumsan tellus' },
  {  request_id: 35, approval_status: 'rejected', approval_date: '1/14/1998', comments: 'sed sagittis nam congue risus semper porta' },
  {  request_id: 36, approval_status: 'approved', approval_date: '2/5/1989', comments: 'consectetuer adipiscing elit proin interdum mauris non ligula pellentesque ultrices' },
  {  request_id: 37, approval_status: 'rejected', approval_date: '4/27/2021', comments: 'dapibus augue vel accumsan tellus nisi eu' },
  {  request_id: 38, approval_status: 'approved', approval_date: '12/9/2002', comments: 'quisque id justo sit amet sapien dignissim vestibulum vestibulum' },
  {  request_id: 39, approval_status: 'pending', approval_date: '9/2/1992', comments: 'nullam molestie nibh in lectus pellentesque at nulla' },
  {  request_id: 40, approval_status: 'pending', approval_date: '10/24/2008', comments: 'ipsum aliquam non mauris morbi' },
  {  request_id: 41, approval_status: 'pending', approval_date: '3/30/2005', comments: 'nulla nisl nunc nisl duis bibendum felis' },
  {  request_id: 42, approval_status: 'rejected', approval_date: '2/6/1993', comments: 'posuere cubilia curae mauris viverra' },
  {  request_id: 43, approval_status: 'rejected', approval_date: '1/17/2015', comments: 'in faucibus orci luctus et' },
  {  request_id: 44, approval_status: 'approved', approval_date: '3/15/1999', comments: 'nunc vestibulum ante ipsum primis in faucibus orci luctus' },
  {  request_id: 45, approval_status: 'approved', approval_date: '2/24/2008', comments: 'ultrices posuere cubilia curae mauris viverra' },
  {  request_id: 46, approval_status: 'approved', approval_date: '7/31/2015', comments: 'amet eros suspendisse accumsan tortor quis turpis sed' },
  {  request_id: 47, approval_status: 'approved', approval_date: '12/3/1981', comments: 'et magnis dis parturient montes nascetur ridiculus mus' },
  {  request_id: 48, approval_status: 'pending', approval_date: '4/6/2007', comments: 'sapien urna pretium nisl ut volutpat sapien arcu sed augue' },
  {  request_id: 49, approval_status: 'rejected', approval_date: '9/2/1984', comments: 'nibh in lectus pellentesque at nulla' },
  {  request_id: 50, approval_status: 'approved', approval_date: '12/10/1986', comments: 'ut tellus nulla ut erat id mauris' }
]
...
allocations_data = [
  { asset_id: 9, employee_id: 4, quantity_allocated: 2, allocation_date: '2/2/2017', return_date: '2/18/2024' },
  { asset_id: 1, employee_id: 1, quantity_allocated: 2, allocation_date: '12/5/2013', return_date: '3/6/2024' },
  { asset_id: 43, employee_id: 3, quantity_allocated: 2, allocation_date: '1/19/2023', return_date: '12/23/2023' },
  { asset_id: 9, employee_id: 2, quantity_allocated: 1, allocation_date: '5/9/2006', return_date: nil },
  { asset_id: 34, employee_id: 1, quantity_allocated: 1, allocation_date: '10/5/1996', return_date: '8/15/2024' },
  { asset_id: 32, employee_id: 2, quantity_allocated: 1, allocation_date: '9/28/2011', return_date: '5/3/2024' },
  { asset_id: 45, employee_id: 3, quantity_allocated: 1, allocation_date: '12/15/1991', return_date: '4/1/2024' },
  { asset_id: 32, employee_id: 1, quantity_allocated: 2, allocation_date: '1/9/2005', return_date: nil },
  { asset_id: 11, employee_id: 3, quantity_allocated: 1, allocation_date: '8/30/2017', return_date: nil },
  {  asset_id: 8, employee_id: 2, quantity_allocated: 1, allocation_date: '6/17/1995', return_date: '5/20/2024' },
  {  asset_id: 56, employee_id: 1, quantity_allocated: 3, allocation_date: '2/19/2023', return_date: '9/1/2024' },
  {  asset_id: 11, employee_id: 1, quantity_allocated: 1, allocation_date: '4/4/2015', return_date: nil },
  {  asset_id: 43, employee_id: 2, quantity_allocated: 3, allocation_date: '5/13/1993', return_date: '2/16/2024' },
  {  asset_id: 34, employee_id: 3, quantity_allocated: 1, allocation_date: '8/3/2012', return_date: '5/22/2024' },
  {  asset_id: 4, employee_id: 2, quantity_allocated: 2, allocation_date: '2/23/1992', return_date: nil },
  {  asset_id: 21, employee_id: 3, quantity_allocated: 3, allocation_date: '1/6/2022', return_date: nil },
  {  asset_id: 13, employee_id: 2, quantity_allocated: 3, allocation_date: '7/23/2004', return_date: '6/16/2024' },
  {  asset_id: 4, employee_id: 3, quantity_allocated: 3, allocation_date: '3/31/2010', return_date: nil },
  {  asset_id: 3, employee_id: 1, quantity_allocated: 2, allocation_date: '10/17/1992', return_date: '5/25/2024' },
  {  asset_id: 21, employee_id: 4, quantity_allocated: 2, allocation_date: '3/15/2020', return_date: nil },
  {  asset_id: 7, employee_id: 3, quantity_allocated: 2, allocation_date: '9/5/1994', return_date: '7/26/2024' },
  {  asset_id: 1, employee_id: 2, quantity_allocated: 3, allocation_date: '7/13/2019', return_date: '2/11/2024' },
  {  asset_id: 7, employee_id: 3, quantity_allocated: 3, allocation_date: '12/13/2007', return_date: '8/18/2024' },
  {  asset_id: 8, employee_id: 4, quantity_allocated: 1, allocation_date: '3/6/1994', return_date: nil },
  {  asset_id: 13, employee_id: 2, quantity_allocated: 3, allocation_date: '12/6/1993', return_date: '9/5/2024' },
  {  asset_id: 5, employee_id: 1, quantity_allocated: 3, allocation_date: '6/29/1991', return_date: '7/5/2024' },
  {  asset_id: 45, employee_id: 4, quantity_allocated: 1, allocation_date: '10/12/2016', return_date: nil },
  {  asset_id: 13, employee_id: 3, quantity_allocated: 2, allocation_date: '1/4/2015', return_date: nil },
  {  asset_id: 43, employee_id: 2, quantity_allocated: 1, allocation_date: '11/8/2012', return_date: '12/31/2023' },
  {  asset_id: 34, employee_id: 1, quantity_allocated: 2, allocation_date: '11/2/2002', return_date: '1/29/2024' }
]
